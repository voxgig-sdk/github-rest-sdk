...
describe("GistDirect", function()
  it("should direct-list-gist", function()
    local setup = gist_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-gist", setup.live and "live" or "unit")
...
function gist_direct_setup(mockres)
