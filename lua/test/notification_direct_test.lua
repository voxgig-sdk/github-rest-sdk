...
describe("NotificationDirect", function()
  it("should direct-list-notification", function()
    local setup = notification_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-notification", setup.live and "live" or "unit")
...
function notification_direct_setup(mockres)
