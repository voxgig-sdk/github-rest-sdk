...
describe("BranchDirect", function()
  it("should direct-list-branch", function()
    local setup = branch_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-branch", setup.live and "live" or "unit")
...
function branch_direct_setup(mockres)
