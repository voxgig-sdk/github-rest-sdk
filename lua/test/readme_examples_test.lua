...
local SDK_MODULE = "github-rest_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["branch"] = { ["test01"] = { id = "test01" } }, ["commit"] = { ["test01"] = { id = "test01" } }, ["gist"] = { ["test01"] = { id = "test01" } }, ["issue"] = { ["test01"] = { id = "test01" } }, ["notification"] = { ["test01"] = { id = "test01" } }, ["org"] = { ["test01"] = { id = "test01" } }, ["pull"] = { ["test01"] = { id = "test01" } }, ["rate_limit"] = { ["test01"] = { id = "test01" } }, ["repo"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
