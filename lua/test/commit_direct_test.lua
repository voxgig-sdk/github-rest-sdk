...
describe("CommitDirect", function()
  it("should direct-list-commit", function()
    local setup = commit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-commit", setup.live and "live" or "unit")
...
function commit_direct_setup(mockres)
