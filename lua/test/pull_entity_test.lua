...
describe("PullEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUBREST_TEST_PULL_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local pull_ref01_data_dt0_load_result = helpers.to_map(pull_ref01_data_dt0_loaded)
...
function pull_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITHUBREST_TEST_PULL_ENTID")
