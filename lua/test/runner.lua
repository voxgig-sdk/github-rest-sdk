...
function runner.env_override(m)
  local live = runner.getenv("GITHUB_REST_TEST_LIVE")
  local override = runner.getenv("GITHUB_REST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GITHUB_REST_TEST_EXPLAIN")
