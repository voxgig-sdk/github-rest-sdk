...
| `files` | `table` | Names and content for the files that make up the gist |
| `html_url` | `string` |  |
| `id` | `string` |  |
| `node_id` | `string` |  |
| `owner` | `table` |  |
...
| --- | --- | --- |
| `assignee` | `any` |  |
| `assignees` | `table` | Logins for Users to assign to this issue |
...
| `html_url` | `string` |  |
| `id` | `number` |  |
| `labels` | `table` | Labels to associate with this issue |
| `milestone` | `table` | The number of the milestone to associate this issue with |
| `node_id` | `string` |  |
...
| Field | Type | Description |
| --- | --- | --- |
| `base` | `table` | The name of the branch you want the changes pulled into |
| `body` | `string` | The contents of the pull request |
| `closed_at` | `string` |  |
| `created_at` | `string` |  |
| `draft` | `boolean` | Indicates whether the pull request is a draft |
| `head` | `table` | The name of the branch where your changes are implemented |
| `html_url` | `string` |  |
| `id` | `number` |  |
| `merged_at` | `string` |  |
| `node_id` | `string` |  |
