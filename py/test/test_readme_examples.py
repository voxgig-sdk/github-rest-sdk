# GithubRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GithubRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GithubRestSDK(...) and GithubRestSDK.test(...) become
#      GithubRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "githubrest_sdk"
_SDK_CLASS = "GithubRestSDK"
