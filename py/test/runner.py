...
class GithubRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GithubRestTestRunner.getenv("GITHUBREST_TEST_LIVE")
        override = GithubRestTestRunner.getenv("GITHUBREST_TEST_OVERRIDE")
        ...
        explain = GithubRestTestRunner.getenv("GITHUBREST_TEST_EXPLAIN")
