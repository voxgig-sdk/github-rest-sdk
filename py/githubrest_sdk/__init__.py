...
from githubrest_sdk.utility import register

# Load features
from githubrest_sdk.feature.base_feature import GithubRestBaseFeature
from githubrest_sdk.features import _has_feature, _make_feature
...
class GithubRestSDK:
    ...
    def get_utility(self):
        return GithubRestUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "GithubRestSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GithubRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Branch(self, data=None) -> "BranchEntity":
        ...
        from githubrest_sdk.entity.branch_entity import BranchEntity
