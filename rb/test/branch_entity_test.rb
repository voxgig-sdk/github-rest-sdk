...
class BranchEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GITHUB_REST_TEST_BRANCH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def branch_basic_setup(extra)
  ...
  entid_env_raw = ENV["GITHUB_REST_TEST_BRANCH_ENTID"]
