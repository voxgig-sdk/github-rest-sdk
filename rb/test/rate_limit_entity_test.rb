...
class RateLimitEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GITHUBREST_TEST_RATE_LIMIT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def rate_limit_basic_setup(extra)
  ...
  entid_env_raw = ENV["GITHUBREST_TEST_RATE_LIMIT_ENTID"]
