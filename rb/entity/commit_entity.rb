...
class CommitEntity
  ...
  # @return [Commit, Hash] the current Commit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Commit fields)
  def match_get
  ...
  #
  # @param reqmatch [CommitListMatch, Hash, nil] match filter (any subset of
  #   Commit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Commit>, Array] the matching Commit items; raises GithubRestError on failure
