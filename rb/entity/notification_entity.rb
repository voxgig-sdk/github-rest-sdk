...
class NotificationEntity
  ...
  def make
    opts = @_entopts.dup
    NotificationEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [NotificationListMatch, Hash, nil] match filter (any subset of
  #   Notification fields); defaults to nil, treated as an empty match that lists all.
