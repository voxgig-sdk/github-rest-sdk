...
class IssueEntity
  ...
  #   as an empty match, so client.Issue.load works with no args).
  ...
  #
  # @param reqmatch [IssueListMatch, Hash, nil] match filter (any subset of
  #   Issue fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
