...
class RateLimitEntity
  ...
  def make
    opts = @_entopts.dup
    RateLimitEntity.new(@_client, opts)
  end
  ...
  # @return [RateLimit, Hash] the current RateLimit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RateLimit fields)
  def match_get
  ...
  #
  # @param reqmatch [RateLimitLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RateLimit.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RateLimit, Hash] the loaded RateLimit; raises GithubRestError on failure
