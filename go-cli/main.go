// Command GithubRest-cli is a CLI + REPL for the GithubRest SDK,
...
const prompt = "github-rest"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "branch commit gist issue notification org pull rate_limit repo search user"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GITHUB_REST_APIKEY (api key), GITHUB_REST_BASE (base url override)")
