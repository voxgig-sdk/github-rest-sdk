...
func registerSDKWords(r *eng.Registry, client *sdk.GithubRestSDK) {
...
func runOp(client *sdk.GithubRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
