...
exports.RateLimitEntity = void 0;
const GithubRestEntityBase_1 = require("../GithubRestEntityBase");
class RateLimitEntity extends GithubRestEntityBase_1.GithubRestEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'rate_limit';
        this.name_ = 'rate_limit';
        this.Name = 'RateLimit';
    }
    make() {
        return new RateLimitEntity(this._client, this.entopts());
    }
...
exports.RateLimitEntity = RateLimitEntity;
//# sourceMappingURL=RateLimitEntity.js.map