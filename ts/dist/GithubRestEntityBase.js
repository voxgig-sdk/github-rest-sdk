...
exports.GithubRestEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends GithubRestEntityBase<Advice>`.
class GithubRestEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.GithubRestEntityBase = GithubRestEntityBase;
//# sourceMappingURL=GithubRestEntityBase.js.map