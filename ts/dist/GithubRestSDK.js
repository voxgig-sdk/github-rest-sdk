...
exports.SDK = exports.GithubRestSDK = exports.GithubRestEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
Object.defineProperty(exports, "GithubRestEntityBase", { enumerable: true, get: function () { return GithubRestEntityBase_1.GithubRestEntityBase; } });
...
class GithubRestSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('GithubRestSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('GithubRestSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('GithubRestSDK: graphql: ' +
...
exports.GithubRestSDK = GithubRestSDK;
const SDK = GithubRestSDK;
exports.SDK = SDK;
//# sourceMappingURL=GithubRestSDK.js.map