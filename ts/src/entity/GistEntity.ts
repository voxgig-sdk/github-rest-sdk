...
class GistEntity extends GithubRestEntityBase<Gist> {
  ...
  make(this: GistEntity) {
    return new GistEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: GistListMatch, ctrl?: Control): Promise<GistEntity[]> {
  ...
  async create(this: any, reqdata?: GistCreateData, ctrl?: Control): Promise<GistEntity> {
