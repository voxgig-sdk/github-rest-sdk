...
function envOverride(m) {
    if ('TRUE' === process.env.GITHUB_REST_TEST_LIVE ||
        'TRUE' === process.env.GITHUB_REST_TEST_OVERRIDE) {
    ...
    m.GITHUB_REST_TEST_EXPLAIN = process.env.GITHUB_REST_TEST_EXPLAIN || m.GITHUB_REST_TEST_EXPLAIN;
    return m;
}
