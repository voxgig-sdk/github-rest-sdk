...
(0, node_test_1.describe)('NotificationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-notification', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-notification', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_REST_TEST_NOTIFICATION_ENTID'];
...
//# sourceMappingURL=NotificationDirect.test.js.map