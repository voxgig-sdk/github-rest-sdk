...
(0, node_test_1.describe)('IssueDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-issue', async (t) => {
    ...
    (0, node_test_1.test)('direct-list-issue', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_REST_TEST_ISSUE_ENTID'];
...
//# sourceMappingURL=IssueDirect.test.js.map