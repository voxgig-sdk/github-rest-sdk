...
(0, node_test_1.describe)('CommitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-commit', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-commit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_REST_TEST_COMMIT_ENTID'];
...
//# sourceMappingURL=CommitDirect.test.js.map