...
function basicSetup(extra) {
    ...
    let idmap = transform(['pull01', 'pull02', 'pull03', 'repo01', 'repo02', 'repo03', 'owner01'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
