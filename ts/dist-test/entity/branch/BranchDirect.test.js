...
(0, node_test_1.describe)('BranchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-branch', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-branch', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_REST_TEST_BRANCH_ENTID'];
...
//# sourceMappingURL=BranchDirect.test.js.map