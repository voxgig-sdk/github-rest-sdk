...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['repo01','repo02','repo03','org01','org02','org03','repo01','repo02','repo03','user01','user02','user03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
