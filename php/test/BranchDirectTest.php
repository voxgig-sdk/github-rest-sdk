...
class BranchDirectTest extends TestCase
{
    public function test_direct_list_branch(): void
    {
        $setup = branch_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-branch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
