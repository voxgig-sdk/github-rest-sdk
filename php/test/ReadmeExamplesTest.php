...
// GithubRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GithubRestSDK::test)
...
{
    private const SDK_CLASS = 'GithubRestSDK';
    ...
    private const SDK_BASE = 'githubrest_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../githubrest_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
