...
// GithubRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GithubRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GithubRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(GithubRestOmni::structfix($val, Struct::undef()))) {
