...
class BranchEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITHUBREST_TEST_BRANCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function branch_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GITHUBREST_TEST_BRANCH_ENTID");
