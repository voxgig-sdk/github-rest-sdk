...
class GistDirectTest extends TestCase
{
    public function test_direct_list_gist(): void
    {
        $setup = gist_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-gist", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
