...
class CommitDirectTest extends TestCase
{
    public function test_direct_list_commit(): void
    {
        $setup = commit_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-commit", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
