...
class BranchEntity
{
     ...
     *
     * @param BranchListMatch|array|null $reqmatch Match filter (any subset
     *   of Branch fields) as an assoc-array; BranchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Branch[]|array A list of Branch items as assoc-arrays at
