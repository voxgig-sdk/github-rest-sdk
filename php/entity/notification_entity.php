...
// GithubRest SDK Notification entity
...
class NotificationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NotificationEntity($this->_client, $opts);
    }

    /**
     * @param Notification|array $args Notification data (assoc-array) to store.
     */
    ...
    /**
     * @return Notification|array The current Notification data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Notification fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Notification fields).
     */
     ...
     *
     * @param NotificationListMatch|array|null $reqmatch Match filter (any subset
     *   of Notification fields) as an assoc-array; NotificationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Notification[]|array A list of Notification items as assoc-arrays at
