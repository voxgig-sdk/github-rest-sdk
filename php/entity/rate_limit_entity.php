...
// GithubRest SDK RateLimit entity
...
class RateLimitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RateLimitEntity($this->_client, $opts);
    }

    /**
     * @param RateLimit|array $args RateLimit data (assoc-array) to store.
     */
    ...
    /**
     * @return RateLimit|array The current RateLimit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RateLimit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RateLimit fields).
     */
    ...
    /**
     * Load a single RateLimit.
     *
     * @param RateLimitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RateLimitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RateLimit|array The loaded RateLimit as an assoc-array at the
