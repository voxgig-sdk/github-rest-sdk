...
class GistEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GistEntity($this->_client, $opts);
    }

    /**
     * @param Gist|array $args Gist data (assoc-array) to store.
     */
    ...
    /**
     * @return Gist|array The current Gist data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gist fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gist fields).
     */
    ...
    /**
     * List Gist items matching the given filter.
     *
     * @param GistListMatch|array|null $reqmatch Match filter (any subset
     *   of Gist fields) as an assoc-array; GistListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gist[]|array A list of Gist items as assoc-arrays at
     ...
     * Create a new Gist.
     *
     * @param GistCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GistCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gist|array The created Gist as an assoc-array at the
