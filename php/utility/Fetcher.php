...
class GithubRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GithubRestSDK/1.0)';
    ...
    public static function call(GithubRestContext $ctx, string $fullurl, array $fetchdef): array
    {
