...
// GithubRest SDK utility: graphql
//
...
class GithubRestGraphql
{
    ...
    // equivalent.
    public static function body(GithubRestContext $ctx): mixed
    {
    ...
    public static function errors(GithubRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
