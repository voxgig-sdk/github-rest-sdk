...
// GithubRest SDK streaming feature
...
class GithubRestStreamingFeature extends GithubRestBaseFeature
{
    ...
    private function _iterate(GithubRestResult $result): \Generator
    {
    ...
    private function _streamable(GithubRestContext $ctx): bool
    {
