...
// GithubRest SDK clienttrack feature
...
class GithubRestClienttrackFeature extends GithubRestBaseFeature
{
    ...
    public function PostConstruct(GithubRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GithubRest-SDK';
