...
class GithubRestRbacFeature extends GithubRestBaseFeature
{
    ...
    private function _required(GithubRestContext $ctx): ?string
    {
    ...
    private function _reject(GithubRestContext $ctx, string $required): void
    {
    ...
    private function _track(GithubRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
