...
// GithubRest SDK idempotency feature
...
class GithubRestIdempotencyFeature extends GithubRestBaseFeature
{
    ...
    private function _mutating(GithubRestContext $ctx): bool
    {
