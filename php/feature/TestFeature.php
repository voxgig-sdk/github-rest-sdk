...
// GithubRest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GithubRestTestFeature extends GithubRestBaseFeature
{
    ...
    public function init(GithubRestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GithubRestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GithubRestParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GithubRestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GithubRestContext $ctx, $op, $args): array
    {
