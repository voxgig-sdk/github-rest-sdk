...
class GithubRestCacheFeature extends GithubRestBaseFeature
{
    ...
    private function _through(GithubRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
