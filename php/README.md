...
The PHP SDK for the GithubRest API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Branch(null)->list(null, null);
...
[$result, $err] = $client->GithubRest(null)->load(
    ["id" => "test01"], null
);
