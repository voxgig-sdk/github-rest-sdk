// Command GithubRest-mcp is an MCP server exposing the GithubRest
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GithubRest_list  — list records of an entity
//	GithubRest_load  — load a single record of an entity
//
