...
// instead of `sdk.NewGithubRestSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GithubRestSDK  { return NewGithubRestSDK(nil) }
func Test() *GithubRestSDK { return TestSDK(nil, nil) }
