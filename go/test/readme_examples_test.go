...
const testSeed = `map[string]any{"entity": map[string]any{"branch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "commit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "gist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "issue": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "org": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pull": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rate_limit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
