...
func NewRateLimitEntity(client *core.GithubRestSDK, entopts map[string]any) *RateLimitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RateLimitEntity) GetName() string { return e.name }
...
func (e *RateLimitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RateLimitEntity) Deleted() bool {
	return e.deleted
}


func (e *RateLimitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRateLimitEntity(e.client, opts)
}

func (e *RateLimitEntity) Data(args ...any) any {
...
func (e *RateLimitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RateLimit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RateLimitEntity) DataTyped(data ...RateLimit) RateLimit {
	if len(data) > 0 {
		return typedFrom[RateLimit](e.Data(asMap(data[0])))
	}
	return typedFrom[RateLimit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RateLimit (all fields
// optional at the wire level).
func (e *RateLimitEntity) MatchTyped(match ...RateLimit) RateLimit {
	if len(match) > 0 {
		return typedFrom[RateLimit](e.Match(asMap(match[0])))
	}
	return typedFrom[RateLimit](e.Match())
}
...
func (e *RateLimitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RateLimitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RateLimitLoadMatch and returns an RateLimit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RateLimitEntity) LoadTyped(reqmatch RateLimitLoadMatch, ctrl map[string]any) (RateLimit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RateLimit{}, err
	}
	return typedFrom[RateLimit](res), nil
}



func (e *RateLimitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RateLimitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RateLimitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RateLimitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RateLimitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
