...
func NewIssueEntity(client *core.GithubRestSDK, entopts map[string]any) *IssueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IssueEntity) GetName() string { return e.name }
...
func (e *IssueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IssueEntity) Deleted() bool {
	return e.deleted
}


func (e *IssueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIssueEntity(e.client, opts)
}

func (e *IssueEntity) Data(args ...any) any {
...
func (e *IssueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *IssueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IssueEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *IssueEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *IssueEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *IssueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IssueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
