...
func NewCommitEntity(client *core.GithubRestSDK, entopts map[string]any) *CommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommitEntity) GetName() string { return e.name }
...
func (e *CommitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommitEntity) Deleted() bool {
	return e.deleted
}


func (e *CommitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommitEntity(e.client, opts)
}

func (e *CommitEntity) Data(args ...any) any {
...
func (e *CommitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Commit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommitEntity) DataTyped(data ...Commit) Commit {
	if len(data) > 0 {
		return typedFrom[Commit](e.Data(asMap(data[0])))
	}
	return typedFrom[Commit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Commit (all fields
// optional at the wire level).
func (e *CommitEntity) MatchTyped(match ...Commit) Commit {
	if len(match) > 0 {
		return typedFrom[Commit](e.Match(asMap(match[0])))
	}
	return typedFrom[Commit](e.Match())
}
...
func (e *CommitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CommitEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommitListMatch and returns []Commit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CommitEntity) ListTyped(reqmatch CommitListMatch, ctrl map[string]any) ([]Commit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Commit](res), nil
}



func (e *CommitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
