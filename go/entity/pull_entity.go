...
func NewPullEntity(client *core.GithubRestSDK, entopts map[string]any) *PullEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PullEntity) GetName() string { return e.name }
...
func (e *PullEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PullEntity) Deleted() bool {
	return e.deleted
}


func (e *PullEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPullEntity(e.client, opts)
}

func (e *PullEntity) Data(args ...any) any {
...
func (e *PullEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PullEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PullEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *PullEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *PullEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
