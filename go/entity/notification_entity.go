...
func NewNotificationEntity(client *core.GithubRestSDK, entopts map[string]any) *NotificationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NotificationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
