...
func NewGistEntity(client *core.GithubRestSDK, entopts map[string]any) *GistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GistEntity) GetName() string { return e.name }
...
func (e *GistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GistEntity) Deleted() bool {
	return e.deleted
}


func (e *GistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGistEntity(e.client, opts)
}

func (e *GistEntity) Data(args ...any) any {
...
func (e *GistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GistEntity) DataTyped(data ...Gist) Gist {
	if len(data) > 0 {
		return typedFrom[Gist](e.Data(asMap(data[0])))
	}
	return typedFrom[Gist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gist (all fields
// optional at the wire level).
func (e *GistEntity) MatchTyped(match ...Gist) Gist {
	if len(match) > 0 {
		return typedFrom[Gist](e.Match(asMap(match[0])))
	}
	return typedFrom[Gist](e.Match())
}
...
func (e *GistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GistEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GistEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GistListMatch and returns []Gist. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GistEntity) ListTyped(reqmatch GistListMatch, ctrl map[string]any) ([]Gist, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Gist](res), nil
}




func (e *GistEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GistCreateData and returns an Gist. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GistEntity) CreateTyped(reqdata GistCreateData, ctrl map[string]any) (Gist, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Gist{}, err
	}
	return typedFrom[Gist](res), nil
}



func (e *GistEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GistEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
