...
## Install
```bash
go get github.com/voxgig-sdk/github-rest-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/github-rest-sdk=../path/to/github.com/voxgig-sdk/github-rest-sdk
```
...
```
github.com/voxgig-sdk/github-rest-sdk/
...
The root package (`github.com/voxgig-sdk/github-rest-sdk`) re-exports everything needed
