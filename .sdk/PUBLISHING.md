...
|---|---|---|
| `ts/` | @voxgig-sdk/github-rest-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/github-rest-sdk \
      --repository voxgig-sdk/github-rest-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/github-rest-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/github-rest-sdk --id=<id>` removes one.
