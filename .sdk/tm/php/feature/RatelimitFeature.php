...
// GithubRest SDK ratelimit feature
...
class GithubRestRatelimitFeature extends GithubRestBaseFeature
{
    ...
    private function _acquire(GithubRestContext $ctx): void
    {
    ...
    private function _track(GithubRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
