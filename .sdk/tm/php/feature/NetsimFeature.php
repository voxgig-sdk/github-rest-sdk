...
class GithubRestNetsimFeature extends GithubRestBaseFeature
{
    ...
    private function _simulate(GithubRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GithubRestContext $ctx, array $applied): void
    {
        $client = $this->client;
