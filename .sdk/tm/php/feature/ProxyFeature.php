...
class GithubRestProxyFeature extends GithubRestBaseFeature
{
    ...
    public function init(GithubRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GithubRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
