...
// GithubRest SDK timeout feature
...
class GithubRestTimeoutFeature extends GithubRestBaseFeature
{
    ...
    private function _with_timeout(GithubRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GithubRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
