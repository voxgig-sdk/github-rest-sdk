...
// GithubRest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GithubRestMakeRequest
{
    public static function call(GithubRestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GithubRestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GithubRestResponse($fetched);
        } else {
