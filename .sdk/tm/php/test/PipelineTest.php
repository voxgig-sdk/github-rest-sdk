...
{
    private static function utility(): GithubRestUtility
    {
        return new GithubRestUtility();
    }
    ...
    private static function ctx(array $over = []): GithubRestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GithubRestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GithubRestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GithubRestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GithubRestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GithubRestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GithubRestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GithubRestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GithubRestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GithubRestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GithubRestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GithubRestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GithubRestResponse([]),
            'result' => new GithubRestResult([]),
        ]);
        [, $err] = GithubRestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new GithubRestSpec([]),
            'response' => null,
            'result' => new GithubRestResult([]),
        ]);
        [, $err] = GithubRestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GithubRestSpec(['step' => 's']),
            'response' => new GithubRestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GithubRestResult([]),
        ]);
        [, $err] = GithubRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GithubRestSpec(['step' => 's']),
            'response' => new GithubRestResponse(self::resp(200, ['v' => 1])),
            'result' => new GithubRestResult([]),
        ]);
        [, $err] = GithubRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GithubRestSpec(['step' => 's']),
            'response' => new GithubRestResponse(self::resp(200, ['v' => 2])),
            'result' => new GithubRestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GithubRestMakeResponse::call($ctx);
    ...
    {
        $preset = new GithubRestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GithubRestSpec([]),
            'response' => new GithubRestResponse([]),
            'result' => new GithubRestResult([]),
        ...
        [$got, $err] = GithubRestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GithubRestResult([])]);
        [, $err] = GithubRestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GithubRestSpec([]), 'result' => null]);
        [, $err] = GithubRestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GithubRestSpec(['step' => 's']),
            'result' => new GithubRestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GithubRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GithubRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GithubRestSpec(['step' => 's']),
            'result' => new GithubRestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GithubRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GithubRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GithubRestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GithubRestSpec([]),
            'result' => new GithubRestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GithubRestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GithubRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GithubRestError('boom', 'boom');
        $utility->fetcher = function (GithubRestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GithubRestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GithubRestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GithubRestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GithubRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GithubRestResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        GithubRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GithubRestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GithubRestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GithubRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GithubRestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GithubRestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GithubRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GithubRestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GithubRestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GithubRestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GithubRestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GithubRestResult(['ok' => false])]);
        $this->expectException(GithubRestError::class);
        GithubRestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GithubRestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GithubRestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        GithubRestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GithubRestBaseFeature();
        $b = new GithubRestBaseFeature();
        GithubRestFeatureAdd::call($ctx, $a);
        GithubRestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GithubRestBaseFeature
    {
        $f = new GithubRestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GithubRestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?GithubRestSpec $spec): GithubRestContext
    {
    ...
    private static function auth_bags(): GithubRestSpec
    {
        return new GithubRestSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        GithubRestPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GithubRestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GithubRestResponse(['headers' => null]),
            'result' => new GithubRestResult([]),
        ]);
        GithubRestResultHeaders::call($ctx);
