...
class GithubRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GithubRestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GithubRestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GithubRestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
