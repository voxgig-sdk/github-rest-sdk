...
class GithubRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GithubRestTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GithubRestTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GithubRestTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
