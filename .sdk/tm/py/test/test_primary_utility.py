...
from projectname_sdk import GithubRestSDK
from projectname_sdk.core.spec import GithubRestSpec
from projectname_sdk.core.result import GithubRestResult
from projectname_sdk.core.response import GithubRestResponse
from projectname_sdk.core.operation import GithubRestOperation
from projectname_sdk.core.error import GithubRestError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GithubRestBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GithubRestError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GithubRestSDK.test(None, None)
        ...
        class TestInitFeature(GithubRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GithubRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GithubRestSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GithubRestSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GithubRestSDK.test(None, setup_opts)
