...
from projectname_sdk.core.control import GithubRestControl
...
class GithubRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GithubRestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GithubRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GithubRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GithubRestError(code, msg, self)
